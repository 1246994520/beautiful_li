  ...
  <div class="row-fluid">
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<th class="center" bgcolor="#EFFFBF">权限</th>
			<th class="center" bgcolor="#BFEFFF">描述</th>
			<th class="center" bgcolor="#EFBFFF">是否可用</th>
		...
		<c:choose>
			<c:when test="${not empty permissionList}">
				...
				<c:forEach items="${permissionList}" var="var" varStatus="vs">
				<tr>
					<td>${var.PERMISSION_ID}</td>
